...
function tdet_finite_vol_nlo_params!(w, params::Dict, a, b, d, N; cutoff=2500e0, μ=630e0)
    mch = params[:mch]
...
function plot_tdet_finite_vol_nlo!(ax, w, params, a, b, d, N)
    tdet = [tdet_finite_vol_nlo_params!(ww, params, a, b, d, N) for ww in w]
...
function pole_finite_vol_nlo!(init_x, params, a, b, d, N)
    ...
    sol = nlsolve(x -> tdet_finite_vol_nlo!(x[1], mch, decons, m_meson, L, a, b, d, N), [init_x*1e0] )
